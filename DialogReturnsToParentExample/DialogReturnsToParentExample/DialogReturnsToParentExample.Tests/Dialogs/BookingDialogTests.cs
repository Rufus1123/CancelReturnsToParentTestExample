...
using DialogReturnsToParentExample.Tests.Common;
using DialogReturnsToParentExample.Tests.Dialogs.TestData;
...
using DialogReturnsToParentExample;
using DialogReturnsToParentExample.Dialogs;

namespace DialogReturnsToParentExample.Tests.Dialogs
{
