...
- In a terminal, navigate to `DialogReturnsToParentExample`

    ```bash
    # change into project folder
    cd DialogReturnsToParentExample
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `DialogReturnsToParentExample` folder
  - Select `DialogReturnsToParentExample.csproj` file
